...
$d = new Management;
$theloai = $d->theloai();
$tintrongtheloai = $d->tintrongtheloaitieptheo();
		        ...
		        <div class="row">
		          ...
		          <div class="col-md-12 text-center">
		            <ul class="pagination">
		              ...
		              <li ><a href="theloai.php?idTL=<?php echo $row_theloai['idTL']?>">1</a></li>
		              <li class="active"><a href="theloaitieptheo.php?idTL=<?php echo $row_theloai['idTL']?>">2</a></li>
		              <li><a href="#">3</a></li>
		              <li><a href="#">...</a></li>
		              <li><a href="#">97</a></li>
		              ...
		              <div class="inner">
		                ...
		                <div class="details">
		                  ...
		                  <div class="detail">
		                    ...
		                    <div class="category"><a href="loaitin.php?idLT=<?php echo $row_recoment['idLT']?>"><?php $d->get_tenloaitin();?></a></div>
		                  </div>
		                </div>
		              </div>
		            </article>
		            ...
		            <article class="article-mini">
		              ...
		              <div class="padding">
		                ...
		                <div class="detail">
		                  ...
		                  <div class="time"><?php $row_recomenttieptheo['Ngay']?></div>
		                </div>
		              </div>
		              </div>
		            </article>
